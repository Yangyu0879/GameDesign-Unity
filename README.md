...
1.将屏幕大小改为 Full HD(1920\*1080)，以后请默认使用此分辨率，并关闭 Low Sync 模式。

2.更改了 UI 大小。并且将游戏进行中的菜单放进预制体中，构造关卡时直接复制即可。

# 5.19 更新 -mjx

1.完善场景 level2-1（95%），加入风力场，level2 系列背景目前我没找到较好的，有资源的可以邦邦
...
3.实现玩家和敌人受伤血液粒子特效。
在 Prefab/ParticleEffect 下可以修改玩家敌人的掉血特效。
对于每个新建的敌人模板，需要把预制体文件拖到 hitSparkEffect 属性上。
